...
module.exports = function (app) {
  ...
  // Matching api 
  app.route('/api/match').post(users.match);
  app.route('/api/invite').post(users.invite);
  app.route('/api/notify').post(users.notify);
  app.route('/api/feedback/send').post(users.sendFeedback);
  app.route('/api/records').get(users.getRecordCounts);
